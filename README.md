...
1. Copy an existing workload that targets the same GPU — e.g. `workloads/qwen3_5_h200.yaml` for H200, `workloads/minimax_m3_b200.yaml` for a nightly B200 recipe, or `workloads/glm_5_2_b200.yaml` for an opt-in long-context B200 benchmark.
